...
public interface IBoundaryFinder {
     ...
     */
    Set<IPixel> findBoundaryPixels(IPixelMatrix matrix, IConnectivityType connectivityType);
     ...
     */
    Set<IPixel> findBoundaryPixels(IPixelMatrix matrix, Set<IPixel> holeElements, IConnectivityType connectivityType);
